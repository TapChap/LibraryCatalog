...
from book.book_label_dict import cat_dict

class xlsxBook:
    def __init__(self, xlsxIndex, book_name, category, series, series_index, author,
    ...
    def __str__(self):
        return (f"Book(index={self.xlsxIndex!r}, book_name={self.book_name!r}, category={self.category!r}, "
                ...
                f"sub_cat={self.sub_cat!r}, sub_cat_index={self.sub_cat_index!r}, label={self.label!r}, "
    ...
    def serialize(self):
        return [
            ...
            self.series_index, self.author, self.sub_cat,self.sub_cat_index,
            self.desc, self.notes, self.librarian_notes
        ]
